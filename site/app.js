...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sessionHelper = __webpack_require__(112);
	    ...
	    syncScrollingFromDocument: getScrollSyncer(function () {
	      for (var i = 0; i < sourceMappedElements.length; i++) {
	        ...
	        if (element.getBoundingClientRect().top >= VIEWPORT_TOP) {
	          ...
	          _sessionHelper2.default.setDocumentScrollTop(documentContainer.scrollTop);
...
/***/ function(module, exports) {
	...
	var sessionHelper = {
	  setDocumentScrollTop: function setDocumentScrollTop(scrollTop) {
