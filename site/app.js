...
/***/ function(module, exports, __webpack_require__) {
	...
	function configureLivePreview(codeMirror, documentContainer, tableOfContentsContainer) {
	  ...
	  var debouncedRender = (0, _debounce2.default)(function (codeMirror) {
	    ...
	    var _Up$parseAndRenderDoc = _writeUp2.default.parseAndRenderDocumentAndTableOfContents(markup, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InlineDocument_1 = __webpack_require__(106);
	var Audio_1 = __webpack_require__(68);
	var Bold_1 = __webpack_require__(54);
	var Blockquote_1 = __webpack_require__(94);
	var CodeBlock_1 = __webpack_require__(96);
	var DescriptionList_1 = __webpack_require__(28);
	var Emphasis_1 = __webpack_require__(51);
	var ExampleInput_1 = __webpack_require__(88);
	var FootnoteBlock_1 = __webpack_require__(29);
	var Footnote_1 = __webpack_require__(30);
	var Heading_1 = __webpack_require__(21);
	var Highlight_1 = __webpack_require__(55);
	var Image_1 = __webpack_require__(70);
	var InlineCode_1 = __webpack_require__(87);
	var InlineNsfl_1 = __webpack_require__(59);
	var InlineNsfw_1 = __webpack_require__(58);
	var InlineSpoiler_1 = __webpack_require__(56);
	var InlineQuote_1 = __webpack_require__(60);
	var Italic_1 = __webpack_require__(53);
	var LineBlock_1 = __webpack_require__(35);
	var Link_1 = __webpack_require__(64);
	var NsflBlock_1 = __webpack_require__(45);
	var NsfwBlock_1 = __webpack_require__(44);
	var OrderedList_1 = __webpack_require__(36);
	var Paragraph_1 = __webpack_require__(103);
	var NormalParenthetical_1 = __webpack_require__(63);
	var PlainText_1 = __webpack_require__(85);
	var SectionLink_1 = __webpack_require__(25);
	var SpoilerBlock_1 = __webpack_require__(43);
	var SquareParenthetical_1 = __webpack_require__(61);
	var Stress_1 = __webpack_require__(52);
	var Table_1 = __webpack_require__(38);
	var ThematicBreak_1 = __webpack_require__(42);
	var UnorderedList_1 = __webpack_require__(37);
	var Video_1 = __webpack_require__(71);
	var InlineSyntaxNodeContainer_1 = __webpack_require__(22);
	var MediaSyntaxNode_1 = __webpack_require__(69);
	var OutlineSyntaxNodeContainer_1 = __webpack_require__(20);
	var RevealableInlineSyntaxNode_1 = __webpack_require__(57);
	var RevealableOutlineSyntaxNode_1 = __webpack_require__(33);
	var RichInlineSyntaxNode_1 = __webpack_require__(31);
	var RichOutlineSyntaxNode_1 = __webpack_require__(34);
	var library = Up_1.Up;
	library.Document = Document_1.Document;
	library.InlineDocument = InlineDocument_1.InlineDocument;
	library.Audio = Audio_1.Audio;
	library.Bold = Bold_1.Bold;
	library.Blockquote = Blockquote_1.Blockquote;
	library.CodeBlock = CodeBlock_1.CodeBlock;
	library.DescriptionList = DescriptionList_1.DescriptionList;
	library.Emphasis = Emphasis_1.Emphasis;
	library.ExampleInput = ExampleInput_1.ExampleInput;
	library.FootnoteBlock = FootnoteBlock_1.FootnoteBlock;
	library.Footnote = Footnote_1.Footnote;
	library.Heading = Heading_1.Heading;
	library.Highlight = Highlight_1.Highlight;
	library.Image = Image_1.Image;
	library.InlineCode = InlineCode_1.InlineCode;
	library.InlineNsfl = InlineNsfl_1.InlineNsfl;
	library.InlineNsfw = InlineNsfw_1.InlineNsfw;
	library.InlineSpoiler = InlineSpoiler_1.InlineSpoiler;
	library.InlineQuote = InlineQuote_1.InlineQuote;
	library.Italic = Italic_1.Italic;
	library.LineBlock = LineBlock_1.LineBlock;
	library.Link = Link_1.Link;
	library.NsflBlock = NsflBlock_1.NsflBlock;
	library.NsfwBlock = NsfwBlock_1.NsfwBlock;
	library.OrderedList = OrderedList_1.OrderedList;
	library.Paragraph = Paragraph_1.Paragraph;
	library.NormalParenthetical = NormalParenthetical_1.NormalParenthetical;
	library.PlainText = PlainText_1.PlainText;
	library.SectionLink = SectionLink_1.SectionLink;
	library.SpoilerBlock = SpoilerBlock_1.SpoilerBlock;
	library.SquareParenthetical = SquareParenthetical_1.SquareParenthetical;
	library.Stress = Stress_1.Stress;
	library.Table = Table_1.Table;
	library.ThematicBreak = ThematicBreak_1.ThematicBreak;
	library.UnorderedList = UnorderedList_1.UnorderedList;
	library.Video = Video_1.Video;
	library.InlineSyntaxNodeContainer = InlineSyntaxNodeContainer_1.InlineSyntaxNodeContainer;
	library.MediaSyntaxNode = MediaSyntaxNode_1.MediaSyntaxNode;
	library.OutlineSyntaxNodeContainer = OutlineSyntaxNodeContainer_1.OutlineSyntaxNodeContainer;
	library.RevealableInlineSyntaxNode = RevealableInlineSyntaxNode_1.RevealableInlineSyntaxNode;
	library.RevealableOutlineSyntaxNode = RevealableOutlineSyntaxNode_1.RevealableOutlineSyntaxNode;
	library.RichInlineSyntaxNode = RichInlineSyntaxNode_1.RichInlineSyntaxNode;
	library.RichOutlineSyntaxNode = RichOutlineSyntaxNode_1.RichOutlineSyntaxNode;
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Settings_1 = __webpack_require__(13);
	...
	var Up = (function () {
	    ...
	    Up.prototype.parseAndRenderInline = function (markup, extraSettings) {
	        var _a = getParsingAndRenderingSettings(extraSettings), parsing = _a.parsing, rendering = _a.rendering;
	        var inlineDocument = this.parseInline(markup, parsing);
	    ...
	    Up.prototype.parseInline = function (markup, extraParsingSettings) {
	        return parseInline_1.parseInline(markup, this.getParsingSettings(extraParsingSettings));
	    };
	...
	(function (Up) {
	    ...
	    Up.parseAndRender = parseAndRender;
	    ...
	    Up.parseAndRenderDocumentAndTableOfContents = parseAndRenderDocumentAndTableOfContents;
	    function parseAndRenderInline(markup, settings) {
	        return defaultUp.parseAndRenderInline(markup, settings);
	    }
	    Up.parseAndRenderInline = parseAndRenderInline;
	    function parse(markup, parsingSettings) {
	        return defaultUp.parse(markup, parsingSettings);
	    }
	    Up.parse = parse;
	    function parseInline(markup, parsingSettings) {
	...
	(function (Settings) {
	    ...
	    (function (Parsing) {
	        var Terms = (function () {
	            ...
	            Object.defineProperty(Terms.prototype, "audio", {
	                get: function () {
	            ...
	            Object.defineProperty(Terms.prototype, "chart", {
	                get: function () {
	            ...
	            Object.defineProperty(Terms.prototype, "highlight", {
	                get: function () {
	            ...
	            Object.defineProperty(Terms.prototype, "image", {
	                get: function () {
	            ...
	            Object.defineProperty(Terms.prototype, "nsfl", {
	                get: function () {
	            ...
	            Object.defineProperty(Terms.prototype, "nsfw", {
	                get: function () {
	            ...
	            Object.defineProperty(Terms.prototype, "sectionLink", {
	                get: function () {
	            ...
	            Object.defineProperty(Terms.prototype, "spoiler", {
	                get: function () {
	            ...
	            Object.defineProperty(Terms.prototype, "table", {
	                get: function () {
	            ...
	            Object.defineProperty(Terms.prototype, "video", {
	                get: function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Document_1 = __webpack_require__(19);
	var HeadingLeveler_1 = __webpack_require__(39);
	var getOutlineSyntaxNodes_1 = __webpack_require__(40);
	var Strings_1 = __webpack_require__(72);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FootnoteBlockInserter = (function () {
	    ...
	    FootnoteBlockInserter.prototype.handleOutlineNodeAndGetBlocklessFootnotes = function (node) {
	        ...
	        if (node instanceof RevealableOutlineSyntaxNode_1.RevealableOutlineSyntaxNode) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InlineSyntaxNodeContainer_1 = __webpack_require__(22);
	var getTextAppearingInline_1 = __webpack_require__(32);
	var getSearchableText_1 = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var LineConsumer_1 = __webpack_require__(41);
	var ThematicBreak_1 = __webpack_require__(42);
	var SpoilerBlock_1 = __webpack_require__(43);
	var NsfwBlock_1 = __webpack_require__(44);
	var NsflBlock_1 = __webpack_require__(45);
	var tryToParseThematicBreakStreak_1 = __webpack_require__(46);
	var tryToParseHeading_1 = __webpack_require__(47);
	var tryToParseBlankLineSeparation_1 = __webpack_require__(97);
	var tryToParseCodeBlock_1 = __webpack_require__(95);
	var tryToParseBlockquote_1 = __webpack_require__(93);
	var tryToParseUnorderedList_1 = __webpack_require__(90);
	var tryToParseOrderedList_1 = __webpack_require__(92);
	var tryToParseDescriptionList_1 = __webpack_require__(98);
	var tryToParseTableOrChart_1 = __webpack_require__(99);
	var getLabeledBlockParser_1 = __webpack_require__(101);
	var parseParagraphOrLineBlock_1 = __webpack_require__(102);
	var Patterns_1 = __webpack_require__(16);
	var CollectionHelpers_1 = __webpack_require__(17);
	function getOutlineSyntaxNodes(args) {
	    ...
	    var outlineConventions = [
	        ...
	        getLabeledBlockParser_1.getLabeledBlockParser(terms.spoiler, SpoilerBlock_1.SpoilerBlock),
	        getLabeledBlockParser_1.getLabeledBlockParser(terms.nsfw, NsfwBlock_1.NsfwBlock),
	        getLabeledBlockParser_1.getLabeledBlockParser(terms.nsfl, NsflBlock_1.NsflBlock),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Heading_1 = __webpack_require__(21);
	var Patterns_1 = __webpack_require__(16);
	var getInlineSyntaxNodes_1 = __webpack_require__(48);
	var isLineFancyOutlineConvention_1 = __webpack_require__(89);
	var HeadingLeveler_1 = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var tokenize_1 = __webpack_require__(49);
	var parse_1 = __webpack_require__(84);
	function getInlineSyntaxNodes(markup, settings) {
	    return parse_1.parse(tokenize_1.tokenize(markup, settings));
	}
	exports.getInlineSyntaxNodes = getInlineSyntaxNodes;
	function getInlineSyntaxNodesForInlineDocument(markup, settings) {
	    return parse_1.parse(tokenize_1.tokenizeForInlineDocument(markup, settings));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var RichConventions_1 = __webpack_require__(50);
	var MediaConventions_1 = __webpack_require__(67);
	var PatternHelpers_1 = __webpack_require__(15);
	var PatternPieces_1 = __webpack_require__(14);
	var Patterns_1 = __webpack_require__(16);
	var Strings_1 = __webpack_require__(72);
	var tryToTokenizeCodeOrUnmatchedDelimiter_1 = __webpack_require__(73);
	var nestOverlappingConventions_1 = __webpack_require__(76);
	var CollectionHelpers_1 = __webpack_require__(17);
	var StringHelpers_1 = __webpack_require__(26);
	var Bracket_1 = __webpack_require__(77);
	var FailedConventionTracker_1 = __webpack_require__(78);
	var ConventionContext_1 = __webpack_require__(79);
	var TextConsumer_1 = __webpack_require__(74);
	var TokenRole_1 = __webpack_require__(65);
	var Token_1 = __webpack_require__(75);
	var Convention_1 = __webpack_require__(80);
	var InflectionHandler_1 = __webpack_require__(81);
	var trimEscapedAndUnescapedOuterWhitespace_1 = __webpack_require__(83);
	function tokenize(markup, settings) {
	    return new Tokenizer(markup, settings).result;
	}
	exports.tokenize = tokenize;
	function tokenizeForInlineDocument(markup, settings) {
	    var result = (new Tokenizer(markup, settings, { isTokenizingInlineDocument: true })).result;
	    return result;
	}
	...
	var Tokenizer = (function () {
	    function Tokenizer(markup, settings, options) {
	        var _this = this;
	    ...
	    Tokenizer.prototype.configureConventions = function (isTokenizingInlineDocument) {
	        ...
	        this.conventions = CollectionHelpers_1.concat([
	            ...
	            : this.getFootnoteConventions().concat(this.getInternalTopicLinkConventions())), this.getLinkifyingUrlConventions(), this.getLinkContentConventions(), [
	            {
	    ...
	    Tokenizer.prototype.getInternalTopicLinkConventions = function () {
	        var _this = this;
	        var term = this.settings.terms.sectionLink;
	        return NORMAL_BRACKETS.map(function (bracket) {
	            return new Convention_1.Convention({
	    ...
	    Tokenizer.prototype.getMediaDescriptionConventions = function () {
	        ...
	        return CollectionHelpers_1.concat([MediaConventions_1.IMAGE, MediaConventions_1.VIDEO, MediaConventions_1.AUDIO].map(function (media) {
	            var mediaTerm = media.term(_this.settings.terms);
	            return NORMAL_BRACKETS.map(function (bracket) {
	                return new Convention_1.Convention({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Link_1 = __webpack_require__(64);
	var TokenRole_1 = __webpack_require__(65);
	var RevealableConvention_1 = __webpack_require__(66);
	exports.EMPHASIS = {
...
/***/ function(module, exports) {
	...
	(function (TokenRole) {
	    ...
	    TokenRole[TokenRole["SectionLink"] = 12] = "SectionLink";
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var InflectionStartDelimiter_1 = __webpack_require__(82);
	var PatternHelpers_1 = __webpack_require__(15);
	var CollectionHelpers_1 = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MediaConventions_1 = __webpack_require__(67);
	var PlainText_1 = __webpack_require__(85);
	var isWhitespace_1 = __webpack_require__(86);
	var CollectionHelpers_1 = __webpack_require__(17);
	var TokenRole_1 = __webpack_require__(65);
	var InlineCode_1 = __webpack_require__(87);
	var ExampleInput_1 = __webpack_require__(88);
	        ...
	        TokenLoop: for (; this.tokenIndex < this.tokens.length; this.tokenIndex++) {
	            ...
	            switch (token.role) {
	                ...
	                case TokenRole_1.TokenRole.SectionLink: {
	                    this.nodes.push(new SectionLink_1.SectionLink(token.value));
	                    continue;
	                }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UnorderedList_1 = __webpack_require__(37);
	var getOutlineSyntaxNodes_1 = __webpack_require__(40);
	var getIndentedBlock_1 = __webpack_require__(91);
	var PatternHelpers_1 = __webpack_require__(15);
	var PatternPieces_1 = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PatternPieces_1 = __webpack_require__(14);
	var getInlineSyntaxNodes_1 = __webpack_require__(48);
	var getTableCells_1 = __webpack_require__(100);
	function tryToParseTableOrChart(args) {
	    ...
	    var hasHeader = markupLineConsumer.consume({
	        linePattern: Patterns_1.NON_BLANK_PATTERN,
	        thenBeforeConsumingLine: function (line) {
	            headerCells = getTableCells_1.getTableCells(line, settings).map(toHeaderCell);
	        }
	    });
	    if (!hasHeader) {
	        return false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function parseInline(markup, settings) {
	    var children = getInlineSyntaxNodes_1.getInlineSyntaxNodesForInlineDocument(markup, settings);
	...
	var HtmlRenderer = (function (_super) {
	    ...
	    HtmlRenderer.prototype.sectionLink = function (sectionLink) {
	        ...
	        var representation = entry
	            ...
	            : new Italic_1.Italic([new PlainText_1.PlainText(sectionLink.sectionTitleSnippet)]);
	    ...
	    HtmlRenderer.prototype.tableOfContentsTitle = function () {
	        var title = new Heading_1.Heading([
	            new PlainText_1.PlainText(this.settings.terms.tableOfContents)], { level: 1 });
