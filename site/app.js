...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sessionHelper = __webpack_require__(113);
	...
	window.addEventListener('unload', function () {
	  _sessionHelper2.default.saveDocumentScrollTop(getElementById('document-container').scrollTop);
	});
	...
	window.addEventListener('pageshow', function () {
	  ...
	  getElementById('document-container').scrollTop = _sessionHelper2.default.getDocumentScrollTop();
	});
...
/***/ function(module, exports) {
	...
	var DOCUMENT_SCROLL_TOP_KEY = 'documentScrollTop';

	var sessionHelper = {
	  saveDocumentScrollTop: function saveDocumentScrollTop(scrollTop) {
	    window.sessionStorage.setItem(DOCUMENT_SCROLL_TOP_KEY, scrollTop);
	  },

	  getDocumentScrollTop: function getDocumentScrollTop() {
	    return window.sessionStorage.getItem(DOCUMENT_SCROLL_TOP_KEY);
	  }
	};
