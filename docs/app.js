...
/***/ function(module, exports, __webpack_require__) {
	...
	function refreshSourceMappedElements(documentationContainer, tableOfContentsContainer) {
	  var visibleTab = isHidden(documentationContainer) ? tableOfContentsContainer : documentationContainer;

	  sourceMappedElements = visibleTab.querySelectorAll('[data-up-source-line]');
	}
